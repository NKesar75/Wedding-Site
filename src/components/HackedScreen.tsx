    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className='absolute inset-0 opacity-10'>
          <div className='text-xs leading-none whitespace-pre-wrap break-all animate-pulse'>
        ...
        <div className='relative z-10 flex flex-col items-center justify-center min-h-screen p-8'>
          ...
          >
            <div className='flex items-center justify-center gap-2 mb-4'>
              ...
              <h1 className='text-2xl md:text-4xl font-bold text-red-500 animate-pulse'>
                SYSTEM COMPROMISED
              </h1>
              <AlertTriangle className='w-8 h-8 text-red-500 animate-pulse' />
            </div>
            <div className='flex items-center justify-center gap-2'>
              ...
              <span className='text-lg'>UNAUTHORIZED ACCESS DETECTED</span>
              <Zap className='w-6 h-6 animate-bounce' />
            </div>
          </motion.div>

          {/* Terminal output */}
          <div className='bg-black/80 border-2 border-green-400 rounded-lg p-6 w-full max-w-2xl'>
            <div className='flex items-center gap-2 mb-4 border-b border-green-400 pb-2'>
              <div className='w-3 h-3 bg-red-500 rounded-full'></div>
              <div className='w-3 h-3 bg-yellow-500 rounded-full'></div>
              <div className='w-3 h-3 bg-green-500 rounded-full'></div>
              <span className='ml-2 text-sm'>root@hacker-terminal</span>
            </div>
          ...
          <AnimatePresence>
            {showSkipButton && (
              <motion.button
                ...
                exit={{ opacity: 0, y: -20 }}
                onClick={handleSkip}
                className='mt-8 px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-semibold transition-colors border-2 border-red-400 hover:border-red-300'
              >
        ...
        <div className='absolute bottom-4 left-0 right-0 text-center'>
          <motion.p
            ...
            className={`text-red-400 font-bold ${
              window.innerWidth < 768 ? "text-md" : "text-xl"
            }`}
          >
